...
class RelationshipsControllerTest < ActionController::TestCase
  ...
  test "should create relationship" do
    assert_difference('Relationship.count') do
      post :create, relationship: { char_name: @relationship.char_name, name: @relationship.name, vibes: @relationship.vibes }
    end
  ...
  test "should update relationship" do
    patch :update, id: @relationship, relationship: { char_name: @relationship.char_name, name: @relationship.name, vibes: @relationship.vibes }
    assert_redirected_to relationship_path(assigns(:relationship))
  end
